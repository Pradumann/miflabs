    ...
    <section id="contact" className="relative px-6 py-24 sm:py-32">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            <h2 className="text-sm font-semibold uppercase tracking-wider text-cyan-400">Contact</h2>
            <h3 className="mt-3 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              Let us make something that lasts.
            </h3>
            <p className="mt-6 text-lg leading-relaxed text-slate-400">
              Ready to turn your idea into an app? I read every message personally and reply within one
              business day. Consultation is completely free, and there is genuinely no harm in it.
            </p>

            <div className="mt-10 space-y-5">
              <a
                href="mailto:hello@makeitforeverlabs.com"
                className="flex items-center gap-4 text-slate-300 transition-colors hover:text-cyan-400"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-800/60 text-cyan-400">
                  <Mail size={22} />
                </div>
                <div>
                  <p className="text-sm text-slate-500">Email</p>
                  <p className="font-medium">hello@makeitforeverlabs.com</p>
                </div>
              </a>
              <a
                href="https://wa.me/447782668183?text=Hi"
                target="_blank"
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium">+44 7782 66 8183</p>
                </div>
              </a>
              <div className="flex items-center gap-4 text-slate-300">
                ...
                <div>
                  ...
                  <p className="font-medium">Remote across Europe</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                <label htmlFor="idea" className="text-sm font-medium text-slate-300">
